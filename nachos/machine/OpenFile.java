...
public class OpenFile {
    ...
    /**
     * Allocate a new unnamed <tt>OpenFile</tt> that is not associated with any file
     * system.
     */
    public OpenFile() {
        this(null, "unnamed");
    ...
    /**
     * Read this file starting at the specified position and return the number of
     * bytes successfully read. If no bytes were read because of a fatal error,
     * returns -1
     *
    ...
    /**
     * Write this file starting at the specified position and return the number of
     * bytes successfully written. If no bytes were written because of a fatal
     * error, returns -1.
     *
    ...
    /**
     * Read this file starting at the current file pointer and return the number of
     * bytes successfully read. Advances the file pointer by this amount. If no
     * bytes could be* read because of a fatal error, returns -1.
     *
     * @param buf    the buffer to store the bytes in.
     * @param offset the offset in the buffer to start storing bytes.
     * @param length the number of bytes to read.
    ...
    /**
     * Write this file starting at the current file pointer and return the number of
     * bytes successfully written. Advances the file pointer by this amount. If no
     * bytes could be written because of a fatal error, returns -1.
     *
     * @param buf    the buffer to get the bytes from.
     * @param offset the offset in the buffer to start getting.
     * @param length the number of bytes to write.
