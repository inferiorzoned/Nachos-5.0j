...
public final class Lib {
    ...
    /**
     * Return a random integer between 0 and <i>range - 1</i>. Must not be called
     * before <tt>seedRandom()</tt> seeds the random number generator.
     *
    ...
    /**
     * Asserts that <i>expression</i> is <tt>true</tt>. If not, then Nachos exits
    ...
    /**
     * Asserts that this call is never made, with the specified error messsage. Same
     * as <tt>assertTrue(false, message)</tt>.
     *
     * @param message the error message.
     */
     ...
     * specify which flags to enable, use the -d command line option. For example,
     * to enable flags a, c, and e, do the following:
     *
     * <p>
     * 
     * <pre>
     ...
     *
     * <p>
     * Nachos uses several debugging flags already, but you are encouraged to add
     * your own.
     *
     ...
     * @return an array containing the contents of the entire file, or <tt>null</tt>
    ...
    /**
     * Convert an int into its little-endian byte string representation, and return
     ...
     * @return a string containing the specified bytes, up to and not including the
    ...
    /**
     * Creates a padded upper-case string representation of the integer argument in
     * base 16.
     *
     * @param i an integer.
    ...
    /**
     * Creates a padded upper-case string representation of the integer argument in
     * base 16, padding to at most the specified number of digits.
     *
     * @param i   an integer.
    ...
    /**
     * Load and return the named class, or return <tt>null</tt> if the class could
     * not be loaded.
     *
    ...
    /**
     * Create and return a new instance of the named class, using the constructor
    ...
    /**
     * Verifies that the specified class is public, and that a static method with
     * the specified name and signature exists, is public, and returns the specified
     * type.
     *
    ...
    /**
     * Verifies that the specified class is public, and that a non-static field with
     * the specified name and type exists, is public, and is not final.
     *
    ...
    /**
     * Verifies that the specified class is public, and that a static field with the
     * specified name and type exists and is public.
     *
