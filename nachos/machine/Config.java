...
public final class Config {
	/**
	 * Load configuration information from the specified file. Must be called before
	 * the Nachos security manager is installed.
	 *
	 ...
	 * @return the value of the specified key, or <tt>defaultValue</tt> if it is not
	 *         present.
	 */
	 ...
	 * @param key          the key to look up.
	 * @param defaultValue the value to return if the key does not exist.
	 * @return the value of the specified key, or <tt>defaultValue</tt> if the key
	 *         does not exist.
	 */
