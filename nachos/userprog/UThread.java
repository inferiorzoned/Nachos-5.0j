...
public class UThread extends KThread {
     ...
     * registers: one for its state while executing user code, and one for its state
     * while executing kernel code. While this thread is not running, its user state
     * is stored here.
     */
